...
![How Chromium Displays Web Pages_ Conceptual application layers.png]({{ "/assets/img/Conceptual-Application-Layers.png" | absolute_url }})
...
## 渲染进程
![Renderingintherenderer-v2.png]({{ "/assets/img/Renderingintherenderer-v2.png" | absolute_url }})
...
## 浏览器进程
![rendering browser.png]({{ "/assets/img/rendering-browser.png" | absolute_url }})
